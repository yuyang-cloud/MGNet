...
def average_recall_vs_avg_nr_proposals(ground_truth, proposals,
    ...
    -------
    recall : 2darray
        recall[i,j] is recall at ith tiou threshold at the jth average number 
        of average number of proposals per video.
    ...
    for ridx, tiou in enumerate(tiou_thresholds):
        ...
        for i, score in enumerate(score_lst):
            ...
            pcn_proposals = np.minimum((score.shape[1] * pcn_lst).astype(np.int), 
                score.shape[1])
